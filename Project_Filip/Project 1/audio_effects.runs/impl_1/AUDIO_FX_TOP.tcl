...
set rc [catch {
  ...
  set_property ip_repo_paths {{d:/DEL/EE2020/EE2020 Lab And Project Files/Project Files/ProjectTemplate@MyWorkDirectory/audio_effects/audio_effects.cache/ip}} [current_project]
  set_property ip_output_repo {{d:/DEL/EE2020/EE2020 Lab And Project Files/Project Files/ProjectTemplate@MyWorkDirectory/audio_effects/audio_effects.cache/ip}} [current_project]
  add_files -quiet {{D:/DEL/EE2020/EE2020 Lab And Project Files/Project Files/ProjectTemplate@MyWorkDirectory/audio_effects/audio_effects.runs/synth_1/AUDIO_FX_TOP.dcp}}
