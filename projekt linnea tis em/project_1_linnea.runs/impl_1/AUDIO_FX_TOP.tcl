...
set rc [catch {
  ...
  set_property webtalk.parent_dir D:/MyWork/project_1_linnea.cache/wt [current_project]
  set_property parent.project_path D:/MyWork/project_1_linnea.xpr [current_project]
  set_property ip_repo_paths d:/MyWork/project_1_linnea.cache/ip [current_project]
  set_property ip_output_repo d:/MyWork/project_1_linnea.cache/ip [current_project]
  add_files -quiet D:/MyWork/project_1_linnea.runs/synth_1/AUDIO_FX_TOP.dcp
  read_xdc D:/MyWork/project_1_linnea.srcs/constrs_1/imports/Learn/Basys3_Master.xdc
